...
export default function Experiences() {
    return (
        <section id="experiences" className="max-w-7xl mx-auto px-6 py-28 border-t border-gray-100">
            {/* Section Header */}
            <div className="mb-20 max-w-3xl">
                ...
                <h2 className="text-3xl md:text-4xl font-semibold leading-tight mb-6">
                    Experience &{' '}
                    <span className="text-gray-600">Engineering Impact</span>{' '}
                ...
                {experiences.map((exp) => (
                    ...
                    >
                        ...
                        <div className="lg:col-span-4 space-y-4">
                            ...
                            <span className="inline-block px-3 py-1 bg-gray-100 text-xs font-semibold text-black rounded-full">
                                {exp.duration}
                            </span>

                            <h3 className="text-2xl font-semibold text-black tracking-tight leading-tight pt-1">
                                {exp.company}
                            </h3>
                            ...
                            <div className="pt-2">
                                <a
                                    ...
                                    className="inline-flex items-center gap-2 px-4 py-2 text-xs font-medium text-black bg-white border border-gray-200 rounded-lg hover:border-black hover:bg-black hover:text-white transition-all duration-200 cursor-pointer"
                                >
                        ...
                        <div className="lg:col-span-8 space-y-6">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {exp.tags.map((tag) => (
                                    <span
                                        key={tag}
                                        className="px-3 py-1 bg-white border border-gray-200 text-xs text-gray-600 rounded-md font-medium group-hover:border-gray-300 transition-colors duration-200"
                                    >
                                        {tag}
                                    </span>
                                ))}
                            ...
                            <div className="relative pl-6 border-l border-gray-200 space-y-4 pt-2">
                                {exp.bullets.map((bullet, bulletIdx) => (
                                    <div key={bulletIdx} className="relative group/bullet">
                                        {/* Dot Indicator */}
                                        <span className="absolute -left-[30px] top-[9px] w-2 h-2 rounded-full bg-gray-300 group-hover/bullet:bg-black transition-colors duration-200" />

                                        <p className="text-sm sm:text-base text-gray-600 leading-relaxed hover:text-black transition-colors duration-250">
                                            {bullet}
                                        </p>
                                    </div>
                                ))}
